...
export class Migration1738172479172 implements MigrationInterface {
    name = 'Migration1738172479172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "calendar_event" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP NOT NULL, "ownerId" integer, CONSTRAINT "PK_176fe24e6eb48c3fef696c7641f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "course" ("code" character varying NOT NULL, "lecSection" character varying NOT NULL, "labSection" character varying NOT NULL, "title" character varying NOT NULL, "scheduleDays" integer array NOT NULL, "scheduleStart" integer NOT NULL, "scheduleEnd" integer NOT NULL, "midtermExamStart" TIMESTAMP, "midtermExamEnd" TIMESTAMP, "finalExamStart" TIMESTAMP, "finalExamEnd" TIMESTAMP, CONSTRAINT "PK_8f787d99e7f8560b6c6ab922664" PRIMARY KEY ("code", "lecSection", "labSection"))`);
        await queryRunner.query(`CREATE TABLE "session" ("id" SERIAL NOT NULL, "CMUUsername" character varying NOT NULL, "CMUPassword" character varying NOT NULL, "mangoToken" character varying NOT NULL, "ownerId" integer, CONSTRAINT "REL_e1dde0bd0402cc9b1967c40a1b" UNIQUE ("ownerId"), CONSTRAINT "PK_f55da76ac1c3ac420f444d2ff11" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "givenName" character varying NOT NULL, "middleName" character varying NOT NULL, "familyName" character varying NOT NULL, "studentNo" integer NOT NULL, CONSTRAINT "UQ_88b93f60baa5df3e6a89d8ee0d4" UNIQUE ("studentNo"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
